...
-skip testing or running unit test for now, just make sure deliver comprehensive review comments and suggestions for the code changes, and also make sure to explain the reason behind the comment and also suggest the solution if possible.
